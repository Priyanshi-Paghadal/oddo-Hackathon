        ...
        <Card>
          <div className="p-5 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-800">My Salary Breakdown</h3>
                <p className="text-xs text-gray-500">Monthly salary and payment status</p>
              </div>
            </div>
          </div>
            ...
            <table className="w-full text-xs">
              <thead className="bg-gray-50 sticky top-0">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left font-bold text-gray-600">Bond Type</th>
                  <th className="px-4 py-3 text-right font-bold text-gray-600">Amount</th>
                  <th className="px-4 py-3 text-center font-bold text-gray-600">Payment Status</th>
                </tr>
              </thead>
                  ...
                  return (
                    <tr key={index} className={`${item.isPartialMonth ? 'bg-orange-50' : 'hover:bg-gray-50'}`}>
                      ...
                      <td className="px-4 py-3 text-center">
                        {item.isPaid ? (
                          <div>
                            <span className="inline-block px-2.5 py-1 rounded-lg text-xs font-bold bg-green-100 text-green-700">
                              ✓ Paid
                            </span>
                            {item.paidAt && (
                              <div className="text-xs text-gray-600 mt-1.5">
                                <div>{formatDate(item.paidAt)}</div>
                                <div className="text-gray-500">{formatTime(item.paidAt, systemSettings.timezone)}</div>
                              </div>
                            )}
                            {item.paidBy && (
                              <div className="text-xs text-gray-500 mt-1">
                          ...
                          <span className="inline-block px-2.5 py-1 rounded-lg text-xs font-semibold bg-gray-100 text-gray-600">
                            Pending
                          </span>
                        )}
                      </td>
